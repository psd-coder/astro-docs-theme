...
Main page shell. Renders sticky header with navigation, sidebar slot, content area, footer, and code copy buttons. Includes ThemeToggle, ThemeScript, and CodeBlockWrapper automatically.

```astro
---
import { Layout } from "@psd-coder/astro-pigment/components";
---
<Layout
  title="Page Title"
...
```astro
---
import { TableOfContents } from "@psd-coder/astro-pigment/components";
...
```astro
---
import { Button } from "@psd-coder/astro-pigment/components";
---
...
```astro
---
import { Icon } from "@psd-coder/astro-pigment/components";
---
<Icon name="github" />
...
```astro
---
import { Footer } from "@psd-coder/astro-pigment/components";
---
<Footer />
```
...
```astro
---
import { ThemeToggle } from "@psd-coder/astro-pigment/components";
---
<ThemeToggle />
```
...
```astro
---
import { InstallPackage } from "@psd-coder/astro-pigment/components";
---
...
```astro
---
import { PrevNextNav } from "@psd-coder/astro-pigment/components";
---
<PrevNextNav
...
```astro
---
import { PageHeading } from "@psd-coder/astro-pigment/components";
---
...
```astro
---
import { CodeEditor } from "@psd-coder/astro-pigment/components/playground";
---
...
```astro
---
import { LivePreview } from "@psd-coder/astro-pigment/components/playground";
---
<LivePreview />
```
...
```astro
---
import { CodeExample } from "@psd-coder/astro-pigment/components/playground";
const files = [
...
```astro
---
import { CodePanels } from "@psd-coder/astro-pigment/components/playground/CodePanels";
const items = [
...
```astro
---
import { ResizablePanes, ResizablePane } from "@psd-coder/astro-pigment/components/playground";
---
...
```astro
---
import { CollapsiblePane } from "@psd-coder/astro-pigment/components/playground";
---
...
```astro
---
import { Tabs, Tab } from "@psd-coder/astro-pigment/components/playground";
---
<Tabs value="one">
